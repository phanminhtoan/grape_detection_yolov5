...
model = torch.load('yolov5m_grape.pt', map_location='cpu')['model'].float().fuse().eval()
...
while(True):
    ...
    # Display the resulting frame
        frame_t = cv2.putText(frame, "So luong chum nho: " + str(num_boxes), (00, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA, False)
